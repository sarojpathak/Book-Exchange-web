    ...
    @if($request->status === 'requested')
        <div class="row py-2" style="background-color: #d9f5ff">
            ...
            <div class="col-md-3">
                <div class="pull-right">
                    <a href="#/{{$request->id}}" class="p-1 btn-outline-info btn my-md-1">Edit</a>
        ...
        <div class="row py-2" style="background: #beffba">
            <div class="col-md-9">
                ...
                has accepted your request to exchange the book <span class="font-weight-bold text-info">"{{$request->book_wanted}}"</span>
                with your book <span class="font-weight-bold text-info">"{{$request->book_offered}}"</span>
            </div>
            <div class="col-md-3">
                <div class="pull-right">
        ...
        <div class="row py-2" style="background: #ffc3bd">
            <div class="col-md-9">
                <span class="font-weight-bold text-primary">{{$request->requested_to}}</span>
                has declined your request to exchange the book <span class="font-weight-bold text-info">"{{$request->book_wanted}}"</span>
                with your book <span class="font-weight-bold text-info">"{{$request->book_offered}}"</span>
            </div>
            <div class="col-md-3">
                <div class="pull-right">
